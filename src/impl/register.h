 ...
 */
static const patomic_impl_t patomic_impl_register[] = {
    {patomic_id_NULL, patomic_kind_UNKN, patomic_impl_create_null,
     patomic_impl_create_explicit_null, patomic_impl_create_transaction_null},
    {patomic_id_STD, patomic_kind_BLTN, patomic_impl_create_std,
     patomic_impl_create_explicit_std, patomic_impl_create_transaction_std},
    {patomic_id_MSVC, patomic_kind_ASM, patomic_impl_create_msvc,
     patomic_impl_create_explicit_msvc, patomic_impl_create_transaction_msvc},
    {patomic_id_TSX, patomic_kind_ASM, patomic_impl_create_tsx,
     patomic_impl_create_explicit_tsx, patomic_impl_create_transaction_tsx},
    {patomic_id_GNU, patomic_kind_BLTN, patomic_impl_create_gnu,
     patomic_impl_create_explicit_gnu, patomic_impl_create_transaction_gnu}};
