...
#define PATOMIC_DEFINE_STORE_OPS(type, name, order, vis_p)                     \
    PATOMIC_WRAPPED_CMPXCHG_DEFINE_OP_STORE(0, 0, patomic_do_cmpxchg_we, type, \
...
#define patomic_do_inc_fe(t, i, y, m, p, o, r)                                 \
    r = __sync_fetch_and_add(p, (t)1u)
#define patomic_do_dec_fe(t, i, y, m, p, o, r)                                 \
    r = __sync_fetch_and_sub(p, (t)1u)
#if PATOMIC_HAVE_IR_TWOS_COMPL
...
#define PATOMIC_DEFINE_OPS_CREATE_SC(type, name, order, vis_p, inv, opsk, min) \
    ...
    PATOMIC_DEFINE_XCHG_OPS_CREATE(type##_unsigned, u##name, order, vis_p,     \
                                   inv, opsk)                                  \
    PATOMIC_DEFINE_BIT_OPS_CREATE(type##_unsigned, u##name, order, vis_p,      \
                                  opsk)                                        \
...
#define PATOMIC_DEFINE_OPS_CREATE_ALL(type, name, min)                         \
    PATOMIC_DEFINE_OPS_CREATE_SC(type, name##_seq_cst, patomic_SEQ_CST,        \
                                 HIDE_P, SHOW, ops, min)                       \
    PATOMIC_DEFINE_OPS_CREATE_SC(type, name##_explicit, order, SHOW_P, HIDE,   \
                                 ops_explicit, min)
...
#elif(PATOMIC_SIZEOF_LLONG == 2 && PATOMIC_STDINT_HAVE_LLONG &&                \
...
#elif(PATOMIC_SIZEOF_I128 == 2 && PATOMIC_STDINT_HAVE_I128 &&                  \
...
#elif(PATOMIC_SIZEOF_LLONG == 4 && PATOMIC_STDINT_HAVE_LLONG &&                \
      defined(PATOMIC_LLONG_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_llong, llong, PATOMIC_LLONG_MIN)
#define PATOMIC_IMPL_GNU_SYNC_TYPE_4 patomic_llong_signed
#define PATOMIC_IMPL_GNU_SYNC_NAME_4 llong
#elif(PATOMIC_SIZEOF_I128 == 4 && PATOMIC_STDINT_HAVE_I128 &&                  \
      defined(PATOMIC_INT128_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_i128, 128, PATOMIC_INT128_MIN)
...
#elif(PATOMIC_SIZEOF_LLONG == 8 && PATOMIC_STDINT_HAVE_LLONG &&                \
      defined(PATOMIC_LLONG_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_llong, llong, PATOMIC_LLONG_MIN)
#define PATOMIC_IMPL_GNU_SYNC_TYPE_8 patomic_llong_signed
#define PATOMIC_IMPL_GNU_SYNC_NAME_8 llong
#elif(PATOMIC_SIZEOF_I128 == 8 && PATOMIC_STDINT_HAVE_I128 &&                  \
      defined(PATOMIC_INT128_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_i128, 128, PATOMIC_INT128_MIN)
...
#elif(PATOMIC_SIZEOF_LLONG == 16 && PATOMIC_STDINT_HAVE_LLONG &&               \
      defined(PATOMIC_LLONG_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_llong, llong, PATOMIC_LLONG_MIN)
#define PATOMIC_IMPL_GNU_SYNC_TYPE_16 patomic_llong_signed
#define PATOMIC_IMPL_GNU_SYNC_NAME_16 llong
#elif(PATOMIC_SIZEOF_I128 == 16 && PATOMIC_STDINT_HAVE_I128 &&                 \
      defined(PATOMIC_INT128_MIN))
PATOMIC_DEFINE_OPS_CREATE_ALL(patomic_i128, 128, PATOMIC_INT128_MIN)
...
patomic_create_ops(size_t byte_width, patomic_memory_order_t order)
{
    ...
    else if PATOMIC_SET_RET(PATOMIC_IMPL_GNU_SYNC_TYPE_1,
                            PATOMIC_IMPL_GNU_SYNC_NAME_1, byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_2)
        else if PATOMIC_SET_RET(PATOMIC_IMPL_GNU_SYNC_TYPE_2,
                                PATOMIC_IMPL_GNU_SYNC_NAME_2, byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_4)
            else if PATOMIC_SET_RET(PATOMIC_IMPL_GNU_SYNC_TYPE_4,
                                    PATOMIC_IMPL_GNU_SYNC_NAME_4, byte_width,
                                    ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_8)
                else if PATOMIC_SET_RET(PATOMIC_IMPL_GNU_SYNC_TYPE_8,
                                        PATOMIC_IMPL_GNU_SYNC_NAME_8,
                                        byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_16)
                    else if PATOMIC_SET_RET(PATOMIC_IMPL_GNU_SYNC_TYPE_16,
...
patomic_create_ops_explicit(size_t byte_width)
{
    ...
    if(byte_width == 0)
    {
        return ret;
...
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_1)
    else if PATOMIC_SET_RET_EXPLICIT(PATOMIC_IMPL_GNU_SYNC_TYPE_1,
                                     PATOMIC_IMPL_GNU_SYNC_NAME_1, byte_width,
                                     ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_2)
        else if PATOMIC_SET_RET_EXPLICIT(PATOMIC_IMPL_GNU_SYNC_TYPE_2,
                                         PATOMIC_IMPL_GNU_SYNC_NAME_2,
                                         byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_4)
            else if PATOMIC_SET_RET_EXPLICIT(PATOMIC_IMPL_GNU_SYNC_TYPE_4,
                                             PATOMIC_IMPL_GNU_SYNC_NAME_4,
                                             byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_8)
                else if PATOMIC_SET_RET_EXPLICIT(PATOMIC_IMPL_GNU_SYNC_TYPE_8,
                                                 PATOMIC_IMPL_GNU_SYNC_NAME_8,
                                                 byte_width, ret)
#endif
#if defined(PATOMIC_IMPL_GNU_SYNC_TYPE_16)
                        ...
                        PATOMIC_IMPL_GNU_SYNC_NAME_16, byte_width, ret)
#endif
