...
PATOMIC_NO_EXPORT
extern int __patomic_cpuid_sig(char * sig_out);
...
PATOMIC_NO_EXPORT
extern unsigned int __patomic_cpuid_max(unsigned int leaf);
#define patomic_cpuid_max __patomic_cpuid_max

/* returns 1 if cpuid supported or 0 if not supported */
PATOMIC_NO_EXPORT
extern int __patomic_cpuid(unsigned int leaf, unsigned int * eax,
...
/* returns 1 if cpuid supported or 0 if not supported */
PATOMIC_NO_EXPORT
extern int __patomic_cpuidex(unsigned int leaf, unsigned int subleaf,
