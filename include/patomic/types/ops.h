...
extern "C"
{
    ...
    typedef void (*patomic_opsig_store_t)(volatile void * obj,
                                          const void * desired);

    typedef void (*patomic_opsig_load_t)(const volatile void * obj, void * ret);

    typedef void (*patomic_opsig_exchange_t)(volatile void * obj,
                                             const void * desired, void * ret);

    typedef int (*patomic_opsig_cmpxchg_t)(volatile void * obj, void * expected,
                                           const void * desired);

    typedef int (*patomic_opsig_test_t)(const volatile void * obj, int offset);

    typedef int (*patomic_opsig_test_modify_t)(volatile void * obj, int offset);

    typedef void (*patomic_opsig_fetch_t)(volatile void * obj, const void * arg,
                                          void * ret);

    typedef void (*patomic_opsig_fetch_noarg_t)(volatile void * obj,
                                                void * ret);

    typedef void (*patomic_opsig_void_t)(volatile void * obj, const void * arg);

    typedef void (*patomic_opsig_void_noarg_t)(volatile void * obj);
    ...
    typedef void (*patomic_opsig_explicit_store_t)(volatile void * obj,
                                                   const void * desired,
                                                   int order);

    typedef void (*patomic_opsig_explicit_load_t)(const volatile void * obj,
                                                  int order, void * ret);

    typedef void (*patomic_opsig_explicit_exchange_t)(volatile void * obj,
                                                      const void * desired,
                                                      int order, void * ret);

    typedef int (*patomic_opsig_explicit_cmpxchg_t)(volatile void * obj,
                                                    void * expected,
                                                    const void * desired,
                                                    int succ, int fail);

    typedef int (*patomic_opsig_explicit_test_t)(const volatile void * obj,
                                                 int offset, int order);

    typedef int (*patomic_opsig_explicit_test_modify_t)(volatile void * obj,
                                                        int offset, int order);

    typedef void (*patomic_opsig_explicit_fetch_t)(volatile void * obj,
                                                   const void * arg, int order,
                                                   void * ret);

    typedef void (*patomic_opsig_explicit_fetch_noarg_t)(volatile void * obj,
                                                         int order, void * ret);

    typedef void (*patomic_opsig_explicit_void_t)(volatile void * obj,
                                                  const void * arg, int order);

    typedef void (*patomic_opsig_explicit_void_noarg_t)(volatile void * obj,
                                                        int order);
     ...
     * - very high likely-hood of successful transactions since nothing will be
     * read or written
     * - pointers in in-params and out-params will not be de-referenced
     *
     * config.attempts == 0:
     * - primary transaction path will not be attempted
     * - status will be set to TABORT_EXPLICIT with reason 0 and attempts_made
     * to 0
     * - if a fallback transaction path is available, it will be executed as
     * normal
     * - pointers in in-params and out-params will not be de-referenced in
     * primary path (but may be de-referenced in fallback path)
     *
     ...
     *
     * NOTE:
     * - if an in-params or out-params pointer is not de-referenced because of
     * the above conditions, it will not be otherwise accessed, and may be NULL
     */

    typedef void (*patomic_opsig_transaction_store_t)(
        volatile void * obj, const void * desired,
        patomic_transaction_config_t config,
        patomic_transaction_result_t * result);

    typedef void (*patomic_opsig_transaction_load_t)(
        const volatile void * obj, patomic_transaction_config_t config,
        void * ret, patomic_transaction_result_t * result);

    typedef void (*patomic_opsig_transaction_exchange_t)(
        volatile void * obj, const void * desired,
        patomic_transaction_config_t config, void * ret,
        patomic_transaction_result_t * result);
    ...
    typedef int (*patomic_opsig_transaction_cmpxchg_t)(
        volatile void * obj, void * expected, const void * desired,
    ...
    typedef int (*patomic_opsig_transaction_test_t)(
        const volatile void * obj, size_t offset,
        patomic_transaction_config_t config,
        patomic_transaction_result_t * result);

    /* returns 0 if transaction aborts */
    typedef int (*patomic_opsig_transaction_test_modify_t)(
        volatile void * obj, size_t offset, patomic_transaction_config_t config,
        patomic_transaction_result_t * result);

    typedef void (*patomic_opsig_transaction_fetch_t)(
        volatile void * obj, const void * arg,
        patomic_transaction_config_t config, void * ret,
        patomic_transaction_result_t * result);

    typedef void (*patomic_opsig_transaction_fetch_noarg_t)(
        volatile void * obj, patomic_transaction_config_t config, void * ret,
        patomic_transaction_result_t * result);
    ...
    typedef void (*patomic_opsig_transaction_void_noarg_t)(
        volatile void * obj, patomic_transaction_config_t config,
        patomic_transaction_result_t * result);
    ...
    typedef int (*patomic_opsig_transaction_double_cmpxchg_t)(
        patomic_transaction_cmpxchg_t cxa, patomic_transaction_cmpxchg_t cxb,
        patomic_transaction_config_wfb_t config,
        patomic_transaction_result_wfb_t * result);
    ...
    typedef int (*patomic_opsig_transaction_multi_cmpxchg_t)(
        const patomic_transaction_cmpxchg_t * cxs_buf, size_t cxs_len,
        patomic_transaction_config_wfb_t config,
        patomic_transaction_result_wfb_t * result);

    /* NOTE: config.width is ignored */
    typedef void (*patomic_opsig_transaction_generic_t)(
        void (*fn)(void *), void * ctx, patomic_transaction_config_t config,
        patomic_transaction_result_t * result);
    ...
    typedef int (*patomic_opsig_transaction_generic_wfb_t)(
        void (*fn)(void *), void * ctx, void (*fallback_fn)(void *),
        void * fallback_ctx, patomic_transaction_config_wfb_t config,
        patomic_transaction_result_wfb_t * result);
     ...
     * - transaction: tconfig parameter, tresult return type (except flag and
     * raw)
     */
