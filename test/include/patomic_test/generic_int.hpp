...
public:
    ...
    void
    store(unsigned char * buf, std::size_t len) noexcept
    {
        assert(width() == len);
    ...
    void
    add(const generic_int & other) noexcept
    {
        /* setup */
    ...
    void
    sub(const generic_int & other) noexcept
    {
        auto arg = other;
        arg.neg();
        this->add(arg);
